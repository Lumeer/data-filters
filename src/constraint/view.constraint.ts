...
import {ConditionType, ConstraintType, ViewConstraintConfig} from '../model';
import {ConstraintData} from './constraint-data';
import {ViewDataValue} from '../data-value/view.data-value';

export class ViewConstraint implements Constraint {
  public readonly type = ConstraintType.View;
  public readonly allowEditFunction = true;

  constructor(public readonly config: ViewConstraintConfig) {}

  public createDataValue(value: any, constraintData: ConstraintData): ViewDataValue {
    return new ViewDataValue(value, this.config, constraintData);
  }

  public createInputDataValue(inputValue: string, value: any, constraintData: ConstraintData): ViewDataValue {
    return new ViewDataValue(value, this.config, constraintData, inputValue);
  }
